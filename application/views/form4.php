...
<!--         -----------------////////////////\\\\\\\\\\\\\\\\\\--------------------------------    -->
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-file"></i>Working on
                            </li>
                        </ol>
                    </div>
   ...
   <div class="col-md-12">
		...
		<?php 
        $attributes = array("class" => "form-horizontal", "id" => "WorkingOn", "name" => "WorkingOn");
        echo form_open(base_url().'login/insert_WorkingOn', $attributes)?>
	 ...
	 <br><br><br>
                 <label for="country" class="col-sm-2 control-label txtblack">Progress</label>
                    ...
                    ?>
                    <?php echo form_dropdown('PercentUtilisation', $options, set_value('PercentUtilisation'), array("class" => "form-control", "id" => "PercentUtilisation"))?>
