        ...
        <div class="top-content">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <br>
                        <u><b><p style="font-size:48px;padding-right:40px"><font color="#C0B283">DevTech</font></p></b></u>
                        <br><br>
                        <h3 class="text-center text-primary"><img src="<?php echo base_url();?>assets/img/home_home.png">
                
                        <!--We provide the most innovative resource management system using "intelligence" to match people with projects.
