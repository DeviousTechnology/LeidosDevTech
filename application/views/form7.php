...
<!--         -----------------////////////////\\\\\\\\\\\\\\\\\\--------------------------------    -->
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-file"></i>Allocate Employee Skills
                            </li>
                        </ol>
                    </div>
                          ...
                          Form 7
                                ...
                                <div class="form-top">
                                    <div class="form-top-left">
                                        <h2>Allocate Employee Skills</h2>
   ...
   <div class="col-md-12">
          <div class="form-box">
                              ...
                              <?php 
        $attributes = array("class" => "form-horizontal", "id" => "EmpSkills", "name" => "EmpSkills");
        echo form_open(base_url().'login/insert_EmployeeSkills', $attributes)?>
        <?php echo $this->session->flashdata('msg'); ?>        
        <label for="country" class="col-sm-2 control-label txtblack">Employee Name</label>
          <div class="col-xs-6 col-sm-7 col-md-10">
             <div class="form-group">
                            <?php
                            
                $attributes = 'class = "form-control input-sm" id = "employee"';
                echo form_dropdown('employee', $employee, set_value('employee'), $attributes);?>
		...
		<label for="country" class="col-sm-2 control-label txtblack"> Skill Name</label>
           <div class="col-xs-6 col-sm-7 col-md-10">
               <div class="form-group">
               		 <?php
                $attributes = 'class = "form-control input-sm" id = "skill"';
                echo form_dropdown('skill', $skill, set_value('skill'), $attributes);?>
	 ...
	 <br><br><br>
                 <label for="country" class="col-sm-2 control-label txtblack">Skill Level</label>
                    ...
                    ?>
                    <?php echo form_dropdown('SkillLevel', $options, set_value('SkillLevel'), array("class" => "form-control", "id" => "SkillLevel"))?>
