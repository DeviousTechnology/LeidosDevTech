...
<!--         -----------------////////////////\\\\\\\\\\\\\\\\\\--------------------------------    -->
    ...
    <div class="col-md-12">
		...
		<?php 
        $attributes = array("class" => "form-horizontal", "id" => "Cost", "name" => "Cost");
        echo form_open(base_url().'login/insert_Cost', $attributes)?>
        <?php echo $this->session->flashdata('msg'); ?>
        
                                
        <label for="country" class="col-sm-2 control-label txtblack">Project Name</label>
          <div class="col-xs-6 col-sm-7 col-md-10">
            <div class="form-group">
            		 <?php
                $attributes = 'class = "form-control input-sm" id = "project"';
          ...
          <br><br><br>
              ...
              <label for="country" class="col-sm-2 control-label txtblack">Resources needed</label>
                    <div class="col-sm-9">
                        <div class="checkbox">
                            <label>
                              <?php echo form_checkbox("ResourcesNeeded[]", "Car" ,set_checkbox("ResourcesNeeded", "Car") )?> Car
                            </label>
                        </div>
                        <div class="checkbox">
                            <label>
                              <?php echo form_checkbox("ResourcesNeeded[]", "Sensors" ,set_checkbox("ResourcesNeeded", "Sensors") )?> Sensors
                            </label>
                        </div>
                        <div class="checkbox">
                            <label>
                              <?php echo form_checkbox("ResourcesNeeded[]", "Corporate Employees" ,set_checkbox("ResourcesNeeded", "Corporate Employees") )?> Corporate Employees
                            </label>
                        </div>
                        <div class="checkbox">
                            <label>
                              <?php echo form_checkbox("ResourcesNeeded[]", "Stationary" ,set_checkbox("ResourcesNeeded", "Stationary") )?> Stationary
                            </label>
                        </div>
                        <div class="checkbox">
                            <label>
                              <?php echo form_checkbox("ResourcesNeeded[]", "Permit to Work" ,set_checkbox("ResourcesNeeded", "Permit to Work") )?> Permit to Work
                            </label>
                        </div>
                        <div class="checkbox">
                            <label>
                              <?php echo form_checkbox("ResourcesNeeded[]", "Construction Workers" ,set_checkbox("ResourcesNeeded", "Construction Workers") )?> Construction Workers
                            </label>
                        </div>
                        <div class="checkbox">
                            <label>
                              <?php echo form_checkbox("ResourcesNeeded[]", "Patent" ,set_checkbox("ResourcesNeeded", "Patent") )?> Patent
                            </label>
                        </div>
                        <div class="checkbox">
                            <label>
                              <?php echo form_checkbox("ResourcesNeeded[]", "Mathematics" ,set_checkbox("ResourcesNeeded", "Delivery Truck") )?> Delivery Truck
                            </label>
                        </div>
                        <br>
                    </div>
          
				<label for="country" class="col-sm-2 control-label txtblack"> Budget</label>
                    <div class="col-xs-6 col-sm-7 col-md-10">
                        <div class="form-group">
                        	<?php echo form_input('Budget', set_value('Budget'), $attribute=array("class"=>"form-control", "id" => "Budget", "placeholder"=>"Budget")); ?>
                        </div>
                     </div>
                     
				<label for="country" class="col-sm-2 control-label txtblack">Required headcount</label>
                      <div class="col-xs-6 col-sm-7 col-md-10">
                         <div class="form-group">
                          		<?php echo form_input('RequiredHeadcount', set_value('RequiredHeadcount'), $attribute=array("class"=>"form-control", "id" => "RequiredHeadcount", "placeholder"=>"Required Headcount")); ?>
      					 </div>
                      </div>
