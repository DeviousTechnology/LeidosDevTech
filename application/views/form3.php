                        ...
                        <ul id="demo" class="collapse">
                           <li>
                            ...
                            <li>
                             ...
                             <li>
                                <a href="<?php echo base_url(). 'login/formCost' ;?>">Add Cost</a>
                            </li>
                              <li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-file"></i>allocate resources
                            </li>
                        </ol>
                    </div>
                    ...
                    <div class="panel panel-default">
                     ...
                     <div class="row">
   					 <div class="col-md-12">
          				<div class="form-box">
                                <div class="form-top">
                                 <?php echo form_open(base_url().'login/create_resource')?>
                                 <?php echo $this->session->flashdata('msgres'); ?>
                                </div>
                                <div class="form-bottom">
                                   
        		<label for="country" class="col-sm-2 control-label txtblack">Resource Name</label>
          <div class="col-xs-6 col-sm-7 col-md-10">
                                    <div class="form-group">
                                    
                                    	<?php echo form_input('Name', set_value('Name'), $attribute=array("class"=>"form-control input-sm", "id" => "Name", "placeholder"=>"Item Name")); ?>
...
<!--                                 <div class="col-xs-6 col-sm-7 col-md-10"> -->
<!--                                     <div class="form-group"> -->
<!--                                         <input type="text" name="name" id="name" class="form-control input-sm" placeholder=""> -->
<!--                                     </div> -->
<!--                                 </div> -->

				<br><br><br>
                 <label for="country" class="col-sm-2 control-label txtblack">Type</label>
                    <div class="col-sm-8">
                         <?php 
                      $options = array(
                    ...
                    <?php echo form_dropdown('Type', $options, set_value('Type'), array("class" => "form-control", "id" => "Type"))?>
                      ...
                      <br><br><br>
                     <label for="country" class="col-sm-2 control-label txtblack">Resource Cost</label>
          		<div class="col-xs-6 col-sm-7 col-md-10">
          			<div class="form-group">          
                  	 	<?php echo form_input('Rcost', set_value('Rcost'), $attribute=array("class"=>"form-control", "id" => "Rcost", "placeholder"=>"Resource Cost ")); ?>
                    </div>
                </div>
                     ...
                     <center>
                    <?php 
						echo form_submit('submit', 'Add Resource', array("class"=>"btn btn-default btn-round-lg btn-lg", "id"=>"submit"));
					?>
					</center>
                    </div>
					<br/>
					<?php echo form_close() ?>
					<?php echo $this->session->flashdata('msgdanger'); ?>
